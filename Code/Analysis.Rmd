...
summarize('LifeExpected (Mean) in America for 2015'=mean(life),
 'LifeExpected (Standard Deviation) in America for 2015'=sd(life))
```
...
In 2015, average Income Middle East & North Africa has been the highest compared to South Asia where it recorded lowest average income.
